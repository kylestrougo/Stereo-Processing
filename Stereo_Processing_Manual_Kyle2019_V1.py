...
###############################################
# Run on linux, assumes latest NASA ASP software is downloaded
...
#Takes user input and creates working directory
#dp = raw_input("Enter a directory path for the location of your new folder (/hd/na10/isis3/): ")
print("")
...
#csvFile = raw_input(str("> Enter text marked as \" * \" (Ex: PEDR_*.csv (245E250E_2S3N_csv_table) ): "))
